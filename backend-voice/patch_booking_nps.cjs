...
const search = `public async updateCustomerSource(tenantId: string, phone: string, source: string): Promise<boolean> {`;
const replace = `public async saveNpsScore(tenantId: string, phone: string, score: number): Promise<boolean> {
  ...
  public async updateCustomerSource(tenantId: string, phone: string, source: string): Promise<boolean> {`;
